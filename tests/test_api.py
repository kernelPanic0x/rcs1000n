"""Tests for RCS1000N RF Socket Support for HASS api."""
import asyncio

import aiohttp
from custom_components.rcs1000n.api import (
    Rcs1000nApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = Rcs1000nApiClient("test", "test", async_get_clientsession(hass))
